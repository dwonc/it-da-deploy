...
const MeetingCreatePage = () => {
  ...
  useEffect(() => {
    ...
    const apiKey =
      import.meta.env.VITE_KAKAO_MAP_KEY || "16531d4c245afb546a5c2abcd7da82a4";
  ...
  const handleSubmit = async () => {
    ...
    try {
      ...
      navigate(
        `/social/chat/success?title=${encodeURIComponent(formData.title)}&roomId=${chatRoomId}`,
      );
    } catch (error: any) {
