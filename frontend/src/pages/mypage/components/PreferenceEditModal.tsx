...
const questions = [
    ...
    },
    {
        ...
        subtitle: "주도 vs 참여",
        options: [
            { value: "LEADER", emoji: "👑", title: "주도형", desc: "모임을 이끄는 것을\n좋아해요" },
            { value: "FOLLOWER", emoji: "🙋", title: "참여형", desc: "편하게 참여하는\n것을 선호해요" },
        ],
        key: "leadershipType",
    },
    {
...
const PreferenceEditModal: React.FC<Props> = ({ isOpen, onClose, userId, onSaved }) => {
    ...
    return (
        <div className="pref-modal-overlay" onClick={handleClose}>
            <div className="pref-modal-container" onClick={(e) => e.stopPropagation()}>
                {/* 헤더 */}
                <div className="pref-modal-header">
                    <button className="pref-modal-close" onClick={handleClose}>✕</button>
                ...
                <div className="pref-progress-container">
                    ...
                    <span className="pref-progress-text">{currentQuestion + 1} / {questions.length}</span>
                </div>
                                    ...
                                    {currentQ.options?.map((option) => (
                                        <button
                                            ...
                                            className={`pref-option-card ${
                                                preferences[currentQ.key as keyof typeof preferences] === option.value
                                                    ? "selected"
                                                    : ""
                                            }`}
                            ...
                            <div className="pref-question-section">
                                ...
                                <div className="pref-interests-grid">
                                    {interestOptions.map((interest) => (
                                        ...
                                        >
                                            <span className="pref-interest-emoji">{interest.emoji}</span>
                                            <span className="pref-interest-title">{interest.title}</span>
                                        </button>
                                    ))}
                                </div>
                                ...
                                <div className="pref-selected-count">
                                    ...
                                    {interests.length < 3 && <span className="pref-count-warning"> (최소 3개)</span>}
                                </div>
                            </div>
                        )}
